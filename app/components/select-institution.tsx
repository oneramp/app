        ...
        >
          ...
          <div className="flex gap-3 items-center flex-col">
            ...
            <Button
              ...
              className="bg-transparent border min-w-fit w-full h-full border-[#444] text-neutral-400 rounded-full p-3 cursor-pointer flex items-center justify-center"
            >
            ...
            <div className="flex-1 h-full w-full">
              <Input
                ...
                className={`bg-transparent border border-[#444] text-lg text-white font-medium rounded-full h-14 pl-6 w-full focus:outline-none ${
