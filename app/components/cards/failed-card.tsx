          ...
          <div className="p-6">
            ...
            <div className="mt-8 w-full flex flex-row gap-4">
              <Button
                ...
                className="w-1/2 bg-neutral-800  hover:bg-transparent text-neutral-300 text-base font-semibold h-14 rounded-xl transition-colors"
              >
                Try again
              </Button>
