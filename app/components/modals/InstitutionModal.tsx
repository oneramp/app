  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-40 flex items-end justify-center md:items-center md:justify-center">
        <div className={`
          bg-[#232323] shadow-2xl relative
          w-full h-[60vh] rounded-t-2xl p-6 max-h-[80vh]
          md:max-w-[380px] md:w-full md:h-auto md:min-h-[50vh] md:rounded-2xl
        ...
        `}>
          ...
          <div className="overflow-y-auto flex-1 max-h-[calc(60vh-180px)] md:max-h-[55vh]">
