      ...
      <div className="bg-[#181818] rounded-2xl max-w-md w-[95%] shadow-2xl flex flex-col border border-[#232323] overflow-hidden">
        ...
        <div className="bg-[#232323] p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-xl text-white font-semibold">Review Transaction</h3>
          </div>
        </div>
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div className="flex flex-col items-center gap-1 mb-3">
            ...
            <div className="flex items-center gap-2">
              <Image src={currencyLogo} alt={currency} width={32} height={32} className="rounded-full" />
              <span className="text-3xl text-white font-light">{amount} {currency}</span>
            </div>
            <div className="text-purple-400 font-semibold">{totalValue}</div>
            <div className="flex items-center gap-2 mt-1">
              <span className="text-xs px-2 py-1 bg-[#232323] rounded-full text-neutral-300">on {network}</span>
              <Image src={networkLogo} alt={network} width={18} height={18} className="rounded-full" />
            </div>
          </div>
