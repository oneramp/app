  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-4">
          {/* EVM Section */}
          <div className="mb-3 text-gray-400 text-sm font-medium">
            EVM
          </div>
              ...
              <div className="mt-4">
                ...
                >
                  <svg className="mr-2" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M8 12H16M8 12L10 10M8 12L10 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  Disconnect
                </Button>
              </div>
